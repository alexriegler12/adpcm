...
unsigned char ima_encode(Ima_Context *ctx, signed short sample){
...
signed short ima_decode(Ima_Context *ctx, unsigned char sample){
	signed long difference=0;
